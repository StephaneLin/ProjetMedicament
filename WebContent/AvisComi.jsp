...
if(null == session.getAttribute("LoginTrue")){
	...
	ajoutLog.Ajout1Ligne(5, "tentative non autorisée d'accès a la page des avis de la commission ASMR et SMR", null);
	response.sendRedirect("index.jsp");
	  ...
	  String login = (String) session.getAttribute("Login");
		  ...
		  AjoutLigne ajoutLog = new AjoutLigne();
		  ajoutLog.Ajout1Ligne(1, "visite de la page des avis de la commission ASMR et SMR", login);
...
<body class="text-center">
		...
		<main role="main" >
			...
			<div class="table-responsive">
				<table id="listeMedAvisLien" class="table table-striped table-bordered table-dark" style="width:100%">
					<thead>
						<tr>
							<th>Denomination</th>
