...
if(null == session.getAttribute("LoginTrue")){
	...
	ajoutLog.Ajout1Ligne(5, "tentative non autorisée d'accès a la page de création d'article", null);
	response.sendRedirect("index.jsp");
	  ...
	  String login = (String) session.getAttribute("Login");
		  ...
		  AjoutLigne ajoutLog = new AjoutLigne();
		  ajoutLog.Ajout1Ligne(1, "visite de la page de création d'article", login);
