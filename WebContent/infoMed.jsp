...
if(null == session.getAttribute("LoginTrue")){
	...
	ajoutLog.Ajout1Ligne(5, "tentative non autorisée d'accès a la page contenant la liste des medicaments (pour afficher leur informations inmportantes)", null);
	response.sendRedirect("index.jsp");
	  ...
	  String login = (String) session.getAttribute("Login");
		  ...
		  AjoutLigne ajoutLog = new AjoutLigne();
		  ajoutLog.Ajout1Ligne(1, "visite de la page contenant la liste des medicaments (pour afficher leur informations inmportantes)", login);
...
<body class="text-center">
		...
		<main role="main" >
			...
			<div class="table-responsive">
				<table id="listeMed" class="table table-striped table-bordered table-dark" style="width:100%">
					<thead>
						<tr>
							<th>Denomination</th>
