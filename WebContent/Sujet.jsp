...
<!--titre de la page-->
<title>Listes des messages</title>
...
if(null == session.getAttribute("LoginTrue")){
	...
	ajoutLog.Ajout1Ligne(1, "visite de la page Sujet.jsp", "patient non identifié");
	}else{
	  // User IS logged in.
	  String login = (String) session.getAttribute("Login");
	
		  AjoutLigne ajoutLog = new AjoutLigne();
		  ajoutLog.Ajout1Ligne(1, "visite de la page Sujet.jsp", login);
...
<body class="text-center">
		...
		<main role="main" >
			...
			<div class="table-responsive">
				<table id="listeMessa" class="table table-striped table-bordered table-dark" style="width:100%">
					<thead>
						<tr>
							<th>Pseudo</th>
							<th>Date</th>
							<th>Message</th>
							<th>Consulter la liste des réponses à ce message</th>
						</tr>
					</thead>
					<tbody>
					</tbody>
