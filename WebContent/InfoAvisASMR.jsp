...
if(null == session.getAttribute("LoginTrue")){
	...
	ajoutLog.Ajout1Ligne(5, "tentative non autorisée d'accès a la page des avis ASMR d'un medicament", null);
	response.sendRedirect("index.jsp");
	  ...
	  String login = (String) session.getAttribute("Login");
		  ...
		  AjoutLigne ajoutLog = new AjoutLigne();
		  ajoutLog.Ajout1Ligne(1, "visite de la page des avis ASMR d'un medicament", login);
...
<body class="text-center">
		...
		<main role="main" >
			...
			<div class="table-responsive">
				<table id="listeasmr" class="table table-striped table-bordered table-dark" style="width:100%">
					<thead>
						<tr>
							<th>Denomination</th>
