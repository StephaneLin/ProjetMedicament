...
if(null == session.getAttribute("LoginTrue")){
	...
	ajoutLog.Ajout1Ligne(1, "visite de la page des médicaments commercialisés", "patient non identifié");
	}else{
	  // User IS logged in.
	  String login = (String) session.getAttribute("Login");
	
		  AjoutLigne ajoutLog = new AjoutLigne();
		  ajoutLog.Ajout1Ligne(1, "visite de la page des médicaments commercialisés", login);
...
<body class="text-center">
		<h1 class="h2">Liste des Medicaments commercialisés</h1>
		<main role="main" >
			<div
				class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom"></div>

			<div class="table-responsive">
				<table id="listeCom" class="table table-striped table-bordered table-dark" style="width:100%">
					<thead>
						<tr>
							<th>Denomination</th>
