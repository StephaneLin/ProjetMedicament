...
/**
 * Servlet implementation class DataTableSMRServlet
 */
@WebServlet("/DataTableSMRServlet")
public class DataTableSMRServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DataTableSMRServlet() {
        super();
