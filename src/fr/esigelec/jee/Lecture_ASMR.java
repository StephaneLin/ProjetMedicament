...
public class Lecture_ASMR {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		int i = 0;
		InputStream flux = new FileInputStream("CIS_HAS_ASMR_bdpm.txt");
		...
		try {
			...
			while (((ligne = buff.readLine()) != null)) {
				...
				String dateASMR = new SimpleDateFormat("yyyy-MM-dd").format(date);
				...
				String requete = "INSERT INTO `avisasmr`(`CIS`, `codeHAS`, `motif`, `dateASMR`, `valeur`, `libelle`) VALUES ('"+ CIS + "','" + codeHAS + "','" + motif + "','"+ new SimpleDateFormat("yyyy-MM-dd").format(date) + "','" + valeur + "','" + libelle + "') ";
