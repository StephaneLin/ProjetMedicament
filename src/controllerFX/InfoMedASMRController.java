...
public class InfoMedASMRController {
	private Stage stage;
	private AdminDAO dao;
	private Alert alert;

	public InfoMedASMRController(Stage stage) {
		if (stage == null) {
	...
	public void redirectasmr(MouseEvent e, int code_cis) {
		stage.setScene(new infoAvisASMR(stage, code_cis).getScene());
