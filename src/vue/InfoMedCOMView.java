...
import controller.*;
import controllerFX.InfoMedCOMController;
...
public class InfoMedCOMView implements ViewMaker {
	private Stage stage;
	private AdminDAO dao;
	private final TableView<CIS_bdpm> table;
	private InfoMedCOMController con;
	

	public InfoMedCOMView(Stage stage) {
		this.stage = stage;
		table = new TableView<CIS_bdpm>();
		con= new InfoMedCOMController(stage);
	}
	...
	public Scene getScene() {
		...
		Text title = new Text("Liste des médicaments commercialisés ");
	...
	private ObservableList<CIS_bdpm> getAllMedicamentsList() {
		dao = new AdminDAO();
		ArrayList<CIS_bdpm> medicamentList = dao.getMedicaments();
