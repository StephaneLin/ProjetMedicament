...
import controllerFX.InfoNonComController;
...
public class InfoNonComView implements ViewMaker {
	private Stage stage;
	private AdminDAO dao;
	private InfoNonComController con;
	private TableView<CIS_bdpm> table;
	
	public InfoNonComView(Stage stage) {
		this.stage = stage;
		con = new InfoNonComController(stage);
	...
	private ObservableList<CIS_bdpm> getAllMedicamentsList() {
		dao = new AdminDAO();
		List<CIS_bdpm> medicamentList = dao.getListMedLess();
